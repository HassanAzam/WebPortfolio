...
jQuery(document).ready(function() {
	...
	if(jQuery('.top_navigation_in div.menu ul li.current-menu-item a').html() == null) {
		jQuery('#menu-top-menu span').html('Menu');
	}/*  else {
		jQuery('.currentmenu2 span').html(jQuery('.top_navigation_in div.menu ul li.current-menu-item a').html());
	} */
	
    jQuery('.top_navigation_in span').click(function(){
